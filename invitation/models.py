...
class Invitation(models.Model):
	...
	def get_absolute_url(self):
		return ('invitation:invitation_register', None, {'invitation_key': self.key})
		#reverse('invitation_register', kwargs={'invitation_key': self.key})
	...
	def is_valid(self):
		...
		"""
		return datetime.datetime.utcnow().replace(tzinfo=utc) < self._expires_at
